...
var tourism = function (options) {
  ...
  return function (grunt) {
    ...
    configuration.shell = {
      ...
      'seal-dependencies-update': {
        command: 'node_modules/tourism/node_modules/npm-check-updates/bin/npm-check-updates -u -f "^seal-.*" && npm update'
      }
    };
    ...
    grunt.registerTask('seal-update', [ 'shell:seal-dependencies-update' ]);
