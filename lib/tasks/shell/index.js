  ...
  return {
    ...
    'update-dependencies': {
      command: function (filterRegexp) {
        ...
        cmd += ' && bash node_modules/tourism/update-dependencies.sh "' + filterRegexp + '"';
        return cmd;
      }
    },
    'start-docker-rabbit': {
    ...
    'stop-docker-rabbit': {
      command: 'docker kill rabbitmq && docker rm -v rabbitmq'
    },
    'start-docker-mongo': {
      command: 'docker run -d --name mongodb -p 27017:27017 dockerfile/mongodb'
    },
    'stop-docker-mongo': {
      command: 'docker kill mongodb && docker rm -v mongodb'
    },
    gitfetch: {
      command: 'git fetch'
    }
